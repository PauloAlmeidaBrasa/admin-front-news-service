...
import { useUserList, useDeleteUser } from '../../hooks/useUser'
...
const UserList =  () => {
  ...
  const handleDelete = (categoryId) => {
    if (confirm("Are you sure you want to delete this category?")) {
      deleteUser.mutate(categoryId);
    }
  };


  let amountUsers = users?.data?.users
  let filteredUsers = []

  if(Array.isArray(amountUsers)) {
      filteredUsers = amountUsers.filter(item => {
